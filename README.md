...
Users are able to checkout to different branch of this package to run on ROS1 and ROS2.
```
# For ROS melodic
git clone https://github.com/Adlink-ROS/neuronbot2.git -b melodic-dev
``` 
